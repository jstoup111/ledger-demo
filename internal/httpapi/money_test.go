...
func TestParseAmount(t *testing.T) {
	tests := []struct {
		...
		{name: "zero whole dollars", input: "0", wantErr: ledger.ErrAmountZero},
		{name: "zero decimal dollars", input: "0.00", wantErr: ledger.ErrAmountZero},
		{name: "negative zero decimal dollars", input: "-0.00", wantErr: ledger.ErrAmountZero},
