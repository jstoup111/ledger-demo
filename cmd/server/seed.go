...
var demoSeed = []seedAccount{
	...
	},
	{
		...
		transactions: []seedTransaction{
			...
			{amount: 30000, description: "Monthly savings contribution"},
			{amount: 30000, description: "Travel envelope deposit"},
			{amount: 30000, description: "Weekend plans savings"},
			{amount: -12000, description: "Train tickets"},
			{amount: 30000, description: "Cabin weekend savings"},
			{amount: -5400, description: "Museum passes"},
			{amount: 30000, description: "Next adventure savings"},
